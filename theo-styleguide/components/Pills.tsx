...
export const Pill = ({ pillType, children, ...props }) => (
...
export const PillOutlined = ({ pillType, children, ...props }) => (
  <Text style={[...pillOutlineStyle(pillType), props.style]}>{children}</Text>
);

function pillFadedStyle(pillType) {
  switch (pillType) {
    case "primary":
...
export const PillFaded = ({ pillType, children, ...props }) => (
  <Text style={[...pillFadedStyle(pillType), props.style]}>{children}</Text>
);
...
export const PillTinted = ({ pillType, children, ...props }) => (
